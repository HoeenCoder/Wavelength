...
exports.BattleMovedex = {
    ...
    troll: {
        ...
        priority: 0,
        self: {boosts: {evasion: 1}, heal: [6,20]},
    ...
    lightshotgigalance: {
        ...
        secondary: {
            chance: 30, self: {boosts: {spa: 1, spe: 1, spd: 1, atk: 1, def: 1}},
        },
        pp: 15,
        priority: 0,
    ...
    saberstrike: {
        ...
        name: "Saber Strike",
        secondary: {
            chance: 100, self: {boosts: {spa: 2}, heal: [1,5]},
        },
        pp: 10,
        priority: 0,
        onPrepareHit: function (target, source, move) {
    ...
    ancientorb: {
        ...
        pp: 10,
        priority: 0,
        self: {boosts: {spe: 1, atk: 1}, heal: [5,20]},
        onPrepareHit: function (target, source) {
            this.attrLastMove('[still]');
