...
exports.BattleScripts = {
    randomSeasonalRegStaffTeam: function (side) {
        ...
        let sets = {
            ...
            '@C733937 123': {
                species: 'Tyranitar', ability: 'Bulletproof', item:'Safety Goggles', gender: 'M',
            ...
            '@Mimiroppu': {
                species: 'Lopunny', ability: 'Limber', item: 'Lopunnite', gender: 'F',
            ...
            '%Serperiorater': {
                species: 'Serperior', ability: 'Sturdy', item: 'Leftovers', gender: 'M',
                moves: ['Psychic', 'Aura Sphere', 'Dark Pulse'],
                signatureMove: 'Saber Strike',
                evs: {spa: 252, spe: 252, spd: 4}, nature: 'Timid',
            },
            '%Vulcaron': {
                species: 'Murkrow', ability: 'Prankster', item: 'Eviolite', gender: 'M',
            ...
            '*SG Bot': {
                ...
                evs: {spa: 252, spd: 252, hp: 4}, nature: 'Adamant',
            },
            // Voices:
            '+Admewn': {
                species: 'Mew', ability: 'Protean', item: 'Expert Belt',
            ...
            '+Auction': {
                ...
                evs: {atk: 252, spd: 8, hp: 248}, nature: 'Adamant',
            },
            '+Hydrostatics': {
            ...
            '+The Run': {
                species: 'Volcanion', ability: 'Protean', item: 'Life Orb',
            ...
            '+UmichBrendan': {
                ...
                evs: {atk: 252, spe: 4, hp: 252}, nature: 'Modest',
            },
            '+Xavier1942': {
                species: 'Porygon2', ability: 'Prankster', item: 'Eviolite',
