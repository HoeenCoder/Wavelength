...
exports.commands = {
	...
	digicredits: function () {
		...
		let popup = `<font size="4"><u><strong>Digimon Plugins Credits:</strong></u></font><br />` +
			...
			`- ${WL.nameColor('Ashley the Pikachu', true)} (Graphics Design, HTML, Coding, Development)<br />` +
			`- ${WL.nameColor('AlfaStorm', true)} (Coding, HTML, Functionality, Development)<br />` +
			`- ${WL.nameColor('Slayer95', true)} (Development, Refactor)<br />` +
			`- ${WL.nameColor('mathfreak231', true)} (Development, Assistance)<br />` +
			`- ${WL.nameColor('fliegenfuerst', true)} (Assistance, Ideas)<br />`;
