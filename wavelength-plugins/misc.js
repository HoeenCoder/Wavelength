...
exports.commands = {
	...
	wlssb: function (target, room, user) {
		...
		if (toId(target) === toId('km')) return this.sendReplyBox(getMonData('krakenmare'));
		if (toId(target) === toId('callie')) return this.sendReplyBox(getMonData('callieagent1'));
		...
		if (toId(target) === toId('hoeen')) return this.sendReplyBox(getMonData('hoeenhero'));
		if (toId(target) === toId('[]')) return this.sendReplyBox(getMonData('arrays'));
		if (toId(target) === toId('mech')) return this.sendReplyBox(getMonData('iSteelX'));
		if (toId(target) === toId('mechsteelix')) return this.sendReplyBox(getMonData('iSteelX'));
		...
		if (toId(target) === toId('stabby')) return this.sendReplyBox(getMonData('stabbythekrabby'));
		if (toId(target) === toId('stk')) return this.sendReplyBox(getMonData('stabbythekrabby'));
		if (toId(target) === toId('twb')) return this.sendReplyBox(getMonData('tidalwavebot'));
		if (toId(target) === toId('tidal')) return this.sendReplyBox(getMonData('tidalwavebot'));
		if (toId(target) === toId('lyc')) return this.sendReplyBox(getMonData('lycaniumz'));
		if (toId(target) === toId('lycan')) return this.sendReplyBox(getMonData('lycaniumz'));
		if (toId(target) === toId('vxn')) return this.sendReplyBox(getMonData('lycaniumz'));
