	...
	profile: function (target, room, user) {
		...
		function showProfile() {
			Economy.readMoney(toId(username), currency => {
				...
				profile += '&nbsp;<font color="#24678d"><strong>Faction:</strong></font> ' + WL.level(toId(username)) + '<br />';
				profile += '&nbsp;<font color="#24678d"><strong>EXP Level:</strong></font> ' + WL.getFaction(toId(username)) + '<br />';
